...
学习率太大导致参数更新幅度过大，每次都"跳过"了最优解，在最优解附近来回震荡，这是[[NeuralNetwork/Troubleshooting/TrainingUnstable|训练不稳]]的典型表现。
...
未归一化的数据会导致[[NeuralNetwork/Troubleshooting/GradientExplodingVanishing|梯度问题]]（梯度爆炸），严重时产生[[NeuralNetwork/Troubleshooting/NanLoss|NaN]]，网络也无法学习。
