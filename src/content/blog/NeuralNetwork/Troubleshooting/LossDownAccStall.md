...
Loss 在平滑下降（与 [[NeuralNetwork/Troubleshooting/LossNotDown|Loss不降]] 不同），但 Acc 几乎不变。
...
3. **[[NeuralNetwork/Training/LearningRate|学习率]]过低**：模型陷入局部最优，参数更新幅度太小，无法跳出当前状态。
...
更强的数据增强强迫模型面对更多变体，减少[[NeuralNetwork/Troubleshooting/Overfitting|过拟合]]：
