...
Loss 确实在下降（不同于[[NeuralNetwork/Troubleshooting/LossNotDown|Loss不降]]），但下降速度极慢：
...
1. **[[NeuralNetwork/Training/LearningRate|学习率]]太小** —— 参数更新步幅太小
2. **[[NeuralNetwork/Training/Optimizers|优化器选择]]不当** —— 用 SGD 但没调好
