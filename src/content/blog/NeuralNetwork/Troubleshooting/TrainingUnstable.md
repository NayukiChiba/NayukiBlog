...
1. **[[NeuralNetwork/Training/LearningRate|学习率]]太大**（最常见）——参数更新步幅过大，在最优解附近弹来弹去，严重时可能产生[[NeuralNetwork/Troubleshooting/NanLoss|NaN]]
2. **Batch Size 太小**——每个 batch 的[[NeuralNetwork/Troubleshooting/GradientExplodingVanishing|梯度方向]]不稳定，不同 batch 之间差异大
