...
![RNNTimeline.png](https://img.yumeko.site/file/articles/RNNComparison/RNNTimeline.webp)
...
![Grad.png](https://img.yumeko.site/file/articles/RNNComparison/Grad.webp)
...
![RNNPower.png](https://img.yumeko.site/file/articles/RNNComparison/RNNPower.webp)
...
![Decision.png](https://img.yumeko.site/file/articles/RNNComparison/Decision.webp)
...
| 你的情况 | 推荐 | 理由 |
|----------|------|------|
| 刚开始学习 RNN | Elman RNN → LSTM | 从简单到复杂，理解演进逻辑 |
...
> 每个架构的详细介绍：
> - [[NeuralNetwork/RNN/Architectures/ElmanNetwork|Elman Network]]
> - [[NeuralNetwork/RNN/Architectures/LSTMMilestone|LSTM 里程碑]]
> - [[NeuralNetwork/RNN/Architectures/BidirectionalRNN|双向 RNN]]
> - [[NeuralNetwork/RNN/Architectures/GRUDevelopment|GRU 的诞生]]
> - [[NeuralNetwork/RNN/Architectures/Seq2Seq|Seq2Seq 架构]]
> - [[NeuralNetwork/RNN/Architectures/AttentionRNN|注意力 RNN]]
>
