...
image: https://img.yumeko.site/file/blog/cover/1780581868287.webp
status: published
---
...
![RNNVSMLP.png](https://img.yumeko.site/file/blog/articles/1780581448616.webp)
...
![HiddenDim.png](https://img.yumeko.site/file/blog/articles/1780581404002.webp)
...
![ParamReuse.png](https://img.yumeko.site/file/blog/articles/1780581424800.webp)

### 3.3 循环计算图：时间维度的深度网络

RNN 的计算图不是一个简单的 DAG（有向无环图），而是包含**循环**的——隐藏状态的值既依赖于当前输入，也依赖于上一时刻自身的值。

![UnrolledRNN.png](https://img.yumeko.site/file/blog/articles/1780581460081.webp)
...
![RNNMode.png](https://img.yumeko.site/file/blog/articles/1780581439462.webp)
...
![RadarChart.png](https://img.yumeko.site/file/blog/articles/1780581430111.webp)
...
- [[NeuralNetwork/RNN/VanillaRNN|循环层详解]] — Vanilla RNN 的数学本质
- [[NeuralNetwork/RNN/LSTM|LSTM 详解]] — 门控机制与细胞状态
- [[NeuralNetwork/RNN/GRU|GRU 详解]] — LSTM 的高效替代
- [[NeuralNetwork/RNN/VanillaRNN|BPTT 详解]] — 循环网络的反向传播
