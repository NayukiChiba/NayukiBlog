...
配合 [[NeuralNetwork/Training/BatchNormalization|BatchNorm]] 可以有效缓解梯度消失问题，同时建议按照 [[NeuralNetwork/Training/WeightInitialization|权重初始化]] 指南选择合适的初始化策略。
...
激活函数的选择直接影响训练稳定性，具体配合方式参见 [[NeuralNetwork/Training/WeightInitialization|权重初始化]] 指南。
