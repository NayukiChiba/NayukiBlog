...
过拟合意味着模型"背诵"了训练数据中的噪声和细节模式（与之相对的是[[NeuralNetwork/Tips/Troubleshooting/Underfitting|欠拟合]]），而非学习通用的分类规则。常见原因：
...
### 方案 1：[[NeuralNetwork/Tips/Techniques/EarlyStoppingGuide|Early Stopping]]（首选）
...
### 方案 2：增加 [[NeuralNetwork/Theory/Dropout|Dropout]]
