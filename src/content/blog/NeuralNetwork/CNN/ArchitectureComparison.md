...
| --- | :---: | :---: | ---: | :---: | --- |
| LeNet-5 | 1998 | 5 | 61K | — | Conv$\rightarrow$Pool$\rightarrow$FC 基础模式 |
| AlexNet | 2012 | 8 | 62M | 15.3% | ReLU + Dropout + GPU 训练 |
| VGG-16 | 2014 | 16 | 138M | 7.3% | 全部 3$\times$3 小卷积核 |
| VGG-19 | 2014 | 19 | 144M | 7.3% | 同 VGG-16，更深 |
| NiN | 2014 | 12 | ~7.5M | — | mlpconv + **GAP 替代 FC** |
| GoogLeNet | 2014 | 22 | 7M | 6.7% | Inception 多分支 + 1$\times$1 降维 |
...
| 时代 | 代表架构 | 设计理念 |
| --- | --- | --- |
| 前深度学习 | LeNet-5 | 简单的 Conv$\rightarrow$Pool$\rightarrow$FC 堆叠 |
...
| 场景 | 推荐架构 | 原因 |
| --- | --- | --- |
| 教学/学习 | LeNet-5 $\rightarrow$ VGG-16 $\rightarrow$ ResNet-18 | 难度递增，覆盖核心思想 |
