...
VGG 在 2014 年 ImageNet 中获得定位任务冠军和分类任务亚军（冠军是 GoogLeNet）。它在设计上证明了"更深 + 更小的卷积核"这一方向是正确的。同年出现的 [[NeuralNetwork/CNN/GoogLeNet|GoogLeNet]] 在效率上更胜一筹，而 2015 年的 [[NeuralNetwork/CNN/ResNet|ResNet]] 用 skip connection 解决了深层网络难训练的问题，彻底超越了 VGG。各架构的全面对比见 [[NeuralNetwork/CNN/ArchitectureComparison|架构对比]]。
