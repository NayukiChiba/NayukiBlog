...
```
Input (3, 224, 224)
    v Conv(7x7, s=2) + BN + ReLU + MaxPool(3x3, s=2)
(64, 56, 56)
    v Stage 1: Bottleneckx3    通道 64->256, stride=1
(256, 56, 56)
    v Stage 2: Bottleneckx4    通道 256->512, stride=2
(512, 28, 28)
    v Stage 3: Bottleneckx6    通道 512->1024, stride=2
(1024, 14, 14)
    v Stage 4: Bottleneckx3    通道 1024->2048, stride=2
(2048, 7, 7)
    v GAP -> FC(2048->1000)
Output
```
