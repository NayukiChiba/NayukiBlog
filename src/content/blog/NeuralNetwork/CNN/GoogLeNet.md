...
Input (3, 224, 224)
    v Stem（预处理）
(192, 28, 28)
    v Inception 3a -> 3b -> MaxPool
(480, 14, 14)
    v Inception 4a -> 4b -> 4c -> 4d -> 4e -> MaxPool
(832, 7, 7)
    v Inception 5a -> 5b
(1024, 7, 7)
    v GAP -> Dropout(0.4) -> FC(1024->1000)
Output
```
...
| 层 | 操作 | 输出形状 |
| --- | --- | --- |
| Conv | 7x7, stride=2, BN+ReLU | $(64, 112, 112)$ |
| Pool | MaxPool 3x3, stride=2 | $(64, 56, 56)$ |
| Conv | 1x1, BN+ReLU | $(64, 56, 56)$ |
| Conv | 3x3, BN+ReLU | $(192, 56, 56)$ |
| Pool | MaxPool 3x3, stride=2 | $(192, 28, 28)$ |
