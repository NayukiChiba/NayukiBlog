...
| --- | --- | --- | ---:|
| Input | — | $(3, 224, 224)$ | 0 |
| Conv1 | Conv(11x11, s=4) + ReLU | $(96, 55, 55)$ | 34,944 |
| Pool1 | MaxPool(3x3, s=2) | $(96, 27, 27)$ | 0 |
| Conv2 | Conv(5x5) + ReLU | $(256, 27, 27)$ | 614,656 |
| Pool2 | MaxPool(3x3, s=2) | $(256, 13, 13)$ | 0 |
| Conv3 | Conv(3x3) + ReLU | $(384, 13, 13)$ | 885,120 |
| Conv4 | Conv(3x3) + ReLU | $(384, 13, 13)$ | 1,327,488 |
| Conv5 | Conv(3x3) + ReLU | $(256, 13, 13)$ | 884,992 |
| Pool5 | MaxPool(3x3, s=2) | $(256, 6, 6)$ | 0 |
| — | Flatten | $(9216,)$ | 0 |
