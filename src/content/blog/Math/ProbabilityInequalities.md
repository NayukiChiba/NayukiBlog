...
|:--|:--|:--|:--|
| $E[X]$ | $1.000$ | $0.368$ | 2.7x |
| $3E[X]$ | $0.333$ | $0.050$ | 6.7x |
| $5E[X]$ | $0.200$ | $0.007$ | 29x |
...
**（4）算术平均 $\geq$ 几何平均**：$f(x) = -\ln x$ 凸 -> $-\ln E[X] \le E[-\ln X]$ -> $E[X] \ge \exp(E[\ln X])$。
